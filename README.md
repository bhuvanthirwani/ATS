...
Built with **Next.js**, **FastAPI**, and **LangChain**, it leverages powerful models like **Google Gemini Pro**, **GPT-4o**, and **Mistral AI** to re-write content, optimize keywords, and generate professional LaTeX documents automatically.
...
<p>
  ...
  <img src="https://img.shields.io/badge/Mistral_AI-000000?style=flat-square&logo=mistralai&logoColor=white" />
...
### 1. Initial Setup
Clone the repository and prepare the manager script.
```bash
...
### 2. Run with Docker
Use the manager script to build and start the application.
```bash
./docker_manager.sh
```
- **Option 1**: Build the images.
- **Option 2**: Run the containers.

### 🎥 Video Demo
Check out the full walkthrough here: [Video Demo Link](https://drive.google.com/file/d/1FmMUe9OQJWlO2W5suKViSPXJ2_PsoWTz/view?usp=drive_link)
